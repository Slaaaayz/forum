...
function Copy(button) {
    var commentElement = button.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.querySelector('.forum-topic-content .lepost');
...
function Edit(button){
    var commentElement = button.closest('.allTopic').querySelector('.forum-topic-content .lepost');
...
function Endedit(button){
    ...
    url = '/forum/topic/' + document.location.href.split("/")[5]
    var data = {
        type:"edit",
        mess: newmess,
        id : button.value,
